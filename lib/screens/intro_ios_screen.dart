...
class IntroIosScreen extends StatefulWidget {
  IntroIosScreen({Key? key}) : super(key: key);

  @override
  _IntroIosScreenState createState() => _IntroIosScreenState();
}

class _IntroIosScreenState extends State<IntroIosScreen> {
  @override
